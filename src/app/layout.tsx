...
export const metadata: Metadata = {
  ...
  description: "Experienced Full Stack Developer with 3+ years in React.js, Next.js, React Native, Node.js, and Nest.js. Specializing in modern web applications and mobile solutions.",
  ...
  openGraph: {
    ...
    description: "Experienced Full Stack Developer specializing in MERN Stack with 3+ years of professional experience",
    type: "website",
    locale: "en_US",
  },
  twitter: {
